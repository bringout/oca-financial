...
Access control and security definitions in account_move_line_repair_info.
...
- **[account_security.xml](../account_move_line_repair_info/security/account_security.xml)**
