...
Access control and security definitions in account_invoice_section_sale_order.
...
- **[res_groups.xml](../account_invoice_section_sale_order/security/res_groups.xml)**
